...
class GoalContainer extends Component {
  ...
  updateIdea = (idea) => {
    ...
    this.setState({ideas: ideas, notification: "Idea updated.", editingIdeaId: null})
  }
  ...
  resetNotification = () => {
    this.setState({notification: "All systems go."})
  }
  ...
  render() {
    return (
      <div>
        <p>Status: <span className="notification">{this.state.notification}</span></p>
        <button className="button-primary" onClick={this.addNewIdea} >+ New Idea</button>
